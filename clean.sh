...
grep -rl 'Haunted' README.md CHANGELOG.md script src system | xargs sed -i '' -E 's/Haunted/Harrowed/g'
grep -rl 'elemental' README.md CHANGELOG.md script src system | xargs sed -i '' -E 's/elemental/environmental/g'
grep -rl 'Elemental' README.md CHANGELOG.md script src system | xargs sed -i '' -E 's/Elemental/Environmental/g'
grep -rl 'rituals' README.md CHANGELOG.md script src system | xargs sed -i '' -E 's/rituals/scenes/g'
grep -rl 'Rituals' README.md CHANGELOG.md script src system | xargs sed -i '' -E 's/Rituals/Scenes/g'
grep -rl 'tormented' README.md CHANGELOG.md script src system | xargs sed -i '' -E 's/tormented/distressed/g'
grep -rl 'Tormented' README.md CHANGELOG.md script src system | xargs sed -i '' -E 's/Tormented/Distressed/g'
grep -rl 'tormented' README.md CHANGELOG.md script src system | xargs sed -i '' -E 's/tormented/distressed/g'
grep -rl 'Tormented' README.md CHANGELOG.md script src system | xargs sed -i '' -E 's/Tormented/Distressed/g'
